...
public final class ImmutableWithHashMap {
	...
	public ImmutableWithHashMap(int i, String n, HashMap<String, String> hm) {
	...
	public static void main(String[] args) {
		...
		ImmutableWithHashMap ce = new ImmutableWithHashMap(i, s, h1);
